...
@SpringBootTest
@Slf4j
class TransferServiceWithoutTransactionTest {

    private final int threadCount;

    @Autowired
    private TransferService transferServiceWithoutTransaction;
    @Autowired
    private AccountRepository accountRepository;

    TransferServiceWithoutTransactionTest() {
        this.threadCount = 3;
    }
        ...
        for (int i = 0; i < threadCount; i++) {
            new Thread(() -> {
                try {
                    ...
                    transferServiceWithoutTransaction.transfer(
