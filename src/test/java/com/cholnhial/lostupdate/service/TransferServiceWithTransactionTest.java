...
@SpringBootTest
@Slf4j
class TransferServiceWithTransactionTest {

    private final int threadCount;

    @Autowired
    private TransferService transferServiceWithTransaction;
    @Autowired
    private AccountRepository accountRepository;

    TransferServiceWithTransactionTest() {
        this.threadCount = 3;
    }
        ...
        for (int i = 0; i < threadCount; i++) {
            new Thread(() -> {
                try {
                    ...
                    transferServiceWithTransaction.transfer(
